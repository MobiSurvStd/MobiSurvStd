...
SCHEMA = {
    "MP1": pl.UInt8,  # Code fichier = 1 (ménage)
    "METH": pl.UInt8,  # Méthode d'enquête du ménage
    "IDM1": pl.UInt8,  # Type d'enquête
    "IDM2": pl.UInt8,  # Méthode de recueil des données (de l'enquête en général)
    "IDM3": pl.UInt16,  # Année de fin d'enquête
    "IDM4": pl.String,  # Code Insee ville centre
    "ZFM": pl.UInt32,  # Zone fine de résidence
    "ECH": pl.UInt32,  # Numéro d’échantillon
    "GM1": pl.String,  # Insee Zone fine du lieu de résidence du ménage
    "STM": pl.UInt32,  # Secteur de tirage dans l’enquête d’origine
    "M1": pl.UInt8,  # Type d'habitat
    "M2": pl.UInt8,  # Type d'occupation du logement
    "M3": pl.UInt8,  # Possession du téléphone fixe
    "M4": pl.UInt8,  # Inscription dans l'annuaire
    "M5": pl.UInt8,  # Disposition d’une connexion internet
    "M6": pl.UInt8,  # Nombre de véhicule (VP) du ménage
    "M7A": pl.UInt8,  # Genre du véhicule n°1
    "M8A": pl.UInt8,  # Type d'énergie du véhicule n°1
    "M9A": pl.UInt16,  # Année de 1ère mise en circulation du véhicule n°1
    "M10A": pl.UInt16,  # Puissance fiscale du véhicule n°1
    "M11A": pl.UInt8,  # Possession du véhicule n°1 par le ménage
    "MAA": pl.UInt8,  # Non-possession du véhicule n°1
    "M12A": pl.UInt8,  # Lieu de stationnement nocturne du véhicule n°1
    "M13A": pl.UInt8,  # Type de stationnement nocturne du véhicule n°1
    "M7B": pl.UInt8,  # Genre du véhicule n°2
    "M8B": pl.UInt8,  # Type d'énergie du véhicule n°2
    "M9B": pl.UInt16,  # Année de 1ère mise en circulation du véhicule n°2
    "M10B": pl.UInt16,  # Puissance fiscale du véhicule n°2
    "M11B": pl.UInt8,  # Possession du véhicule n°2 par le ménage
    "MBB": pl.UInt8,  # Non-possession du véhicule n°2
    "M12B": pl.UInt8,  # Lieu de stationnement nocturne du véhicule n°2
    "M13B": pl.UInt8,  # Type de stationnement nocturne du véhicule n°2
    "M7C": pl.UInt8,  # Genre du véhicule n°3
    "M8C": pl.UInt8,  # Type d'énergie du véhicule n°3
    "M9C": pl.UInt16,  # Année de 1ère mise en circulation du véhicule n°3
    "M10C": pl.UInt16,  # Puissance fiscale du véhicule n°3
    "M11C": pl.UInt8,  # Possession du véhicule n°3 par le ménage
    "MCC": pl.UInt8,  # Non-possession du véhicule n°3
    "M12C": pl.UInt8,  # Lieu de stationnement nocturne du véhicule n°3
    "M13C": pl.UInt8,  # Type de stationnement nocturne du véhicule n°3
    "M7D": pl.UInt8,  # Genre du véhicule n°4
    "M8D": pl.UInt8,  # Type d'énergie du véhicule n°4
    "M9D": pl.UInt16,  # Année de 1ère mise en circulation du véhicule n°4
    "M10D": pl.UInt16,  # Puissance fiscale du véhicule n°4
    "M11D": pl.UInt8,  # Possession du véhicule n°4 par le ménage
    "MDD": pl.UInt8,  # Non-possession du véhicule n°4
    "M12D": pl.UInt8,  # Lieu de stationnement nocturne du véhicule n°4
    "M13D": pl.UInt8,  # Type de stationnement nocturne du véhicule n°4
    "M14": pl.UInt8,  # Nombre de 2/3-roues motorisé du ménage
    "M15A": pl.UInt8,  # Genre du 2/3-roues motorisé n°1
    "M16A": pl.UInt8,  # Cylindrée du 2/3-roues motorisé n°1
    "M17A": pl.UInt8,  # Type de moteur thermique du 2/3-roues motorisé n°1
    "M18A": pl.UInt16,  # Année de mise en circulation du 2/3-roues motorisé n°1
    "M19A": pl.UInt8,  # Lieu de stationnement nocturne du 2/3-roues motorisé n°1
    "M20A": pl.UInt8,  # Type de stationnement nocturne du 2/3-roues motorisé n°1
    "M15B": pl.UInt8,  # Genre du 2/3-roues motorisé n°2
    "M16B": pl.UInt8,  # Cylindrée du 2/3-roues motorisé n°2
    "M17B": pl.UInt8,  # Type de moteur thermique du 2/3-roues motorisé n°2
    "M18B": pl.UInt16,  # Année de mise en circulation du 2/3-roues motorisé n°2
    "M19B": pl.UInt8,  # Lieu de stationnement nocturne du 2/3-roues motorisé n°2
    "M20B": pl.UInt8,  # Type de stationnement nocturne du 2/3-roues motorisé n°2
    "M15C": pl.UInt8,  # Genre du 2/3-roues motorisé n°3
    "M16C": pl.UInt8,  # Cylindrée du 2/3-roues motorisé n°3
    "M17C": pl.UInt8,  # Type de moteur thermique du 2/3-roues motorisé n°3
    "M18C": pl.UInt16,  # Année de mise en circulation du 2/3-roues motorisé n°3
    "M19C": pl.UInt8,  # Lieu de stationnement nocturne du 2/3-roues motorisé n°3
    "M20C": pl.UInt8,  # Type de stationnement nocturne du 2/3-roues motorisé n°3
    "M15D": pl.UInt8,  # Genre du 2/3-roues motorisé n°4
    "M16D": pl.UInt8,  # Cylindrée du 2/3-roues motorisé n°4
    "M17D": pl.UInt8,  # Type de moteur thermique du 2/3-roues motorisé n°4
    "M18D": pl.UInt16,  # Année de mise en circulation du 2/3-roues motorisé n°4
    "M19D": pl.UInt8,  # Lieu de stationnement nocturne du 2/3-roues motorisé n°4
    "M20D": pl.UInt8,  # Type de stationnement nocturne du 2/3-roues motorisé n°4
    "M21": pl.UInt8,  # Nombre de vélos à disposition
    "M22": pl.UInt8,  # Nombre de vélos électriques
    "M23": pl.UInt8,  # Disposition d'un lieu de stationnement vélo au domicile
    "COE0": pl.Float64,  # Coefficient de redressement Ménage
}
...
HOUSING_TYPE_MAP = {
    ...
    3: "apartment",  # Petit collectif
    4: "apartment",  # Grand collectif
    5: "other",  # Autres
}
...
CAR_FUEL_TYPE_MAP = {
    ...
    7: "other",  # Autre
    8: None,  # In Chambery-2022, 8 is used instead of 9.
    9: None,  # NR-Refus
}
...
def standardize_households(
    ...
    lf = lf.with_columns(
        original_household_id=pl.struct("METH", "ECH", "STM"),
        home_draw_zone="STM",
...
def standardize_cars(source: str | bytes, households: pl.LazyFrame):
    lf = scan_households(source)
    # Add household_id.
    lf = lf.with_columns(original_household_id=pl.struct("METH", "ECH", "STM")).join(
    ...
    lf = pl.concat(
        (
            lf.select(
                "household_id",
                original_car_id=pl.struct("METH", "ECH", "STM", index=pl.lit(a, dtype=pl.String)),
        ...
        (
            lf.select(
                ...
                original_motorcycle_id=pl.struct(
                    "METH", "ECH", "STM", index=pl.lit(a, dtype=pl.String)
                ),
